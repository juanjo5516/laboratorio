                            ...
                            <div class="card-body p-5">
                                ...
                                <form autocomplete="off" enctype="multipart/form-data" id="formulario" v-on:submit.prevent="submit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="codigo" name="codigo" type="text" v-model="material.codigo" v-validate="'required'">
        ...
        methods: {
            submit() {
                this.$validator.validate().then(isValid => {
                    if(isValid) {
                        axios.post('/api/materiales/' + this.$route.params.id, new FormData(document.getElementById('formulario')))
                        .then(response => {
                            Swal.fire('Actualización exitosa', 'El material fue guardado en la base de datos', 'success')
                        })
                        .catch(error => {
